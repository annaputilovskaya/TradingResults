...
class TestQueries:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                {"oil_id": "A200", "delivery_type_id": "A", "delivery_basis_id": "ABS"},
                None,
                None,
                0,
            ),
    ...
    async def test_get_filtered_trading_results(
        self, filters, start_date, end_date, amount, get_async_session
    ):
        db_results = await get_filtered_trading_results(
